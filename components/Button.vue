...
<template>
	<component
		:is="buttonType"
		class="flex flex-row justify-center items-center py-4 2xl:py-5.5 pl-8 2xl:pl-9 pr-6.5 2xl:pr-7.5 hover:active:opacity-80 disabled:opacity-50 disabled:pointer-events-none rounded-full text-white font-medium text-base md:text-tiny lg:text-base xl:text-lg 2xl:text-basexl capitalize bg-custom-l-gradient from-purple to-secondary"
		v-bind="anchorProps"
